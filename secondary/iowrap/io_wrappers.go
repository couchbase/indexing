...
////////////////////////////////////////////////////////////////////////////////////////////////////
// io METHOD wrappers -- add more as needed
////////////////////////////////////////////////////////////////////////////////////////////////////

// Io_Read wraps Go-native METHOD io.Read for disk failure tracking.
func Io_Read(this io.Reader, p []byte) (n int, err error) {
	n, err = this.Read(p)
	if err != nil {
		countDiskFailures(err)
	}
