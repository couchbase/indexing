...
var ErrPlannerPlacementMove = errors.New("Planner Placement solution.moveIndex failed.")
...
const INDEXER_80_VERSION = 10
const INDEXER_81_VERSION = 11

const INDEXER_CUR_VERSION = INDEXER_81_VERSION
