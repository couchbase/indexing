...
// GetServerScanReport implements queryport.client.ResponseReader{}. The server
// only attaches a scan report to the StreamEndResponse, never to a
// ResponseStream, so this always returns nil;
