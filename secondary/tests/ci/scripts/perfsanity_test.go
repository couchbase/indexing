...
func TestPerfInitialIndexBuild(t *testing.T) {
	...
	log.Printf("PERFSTAT InitialBuild %v seconds for %d documents\n", initialBuildtime, numdocs)
...
func TestPerfScanLatency_Lookup_StaleOk(t *testing.T) {
	...
	_, meanLatency, percentile80_ScanLatency, percentile95_ScanLatency, throughput := RunScanTest(t, configfile)
	Throughput_Lookup_StaleOk = throughput
	log.Printf("PERFSTAT AverageLatency %v milliseconds", meanLatency)
	log.Printf("PERFSTAT 95thPercentileLatency %v milliseconds", percentile95_ScanLatency)
	log.Printf("PERFSTAT 80thPercentileLatency %v milliseconds", percentile80_ScanLatency)
}

func TestPerfScanThroughput_Lookup_StaleOk(t *testing.T) {
	log.Printf("In TestPerfScanLatency_Lookup_StaleOk()")
	log.Printf("PERFSTAT Throughput %v rows/sec", Throughput_Lookup_StaleOk)
}
...
func TestPerfScanLatency_Range_StaleOk(t *testing.T) {
	...
	_, meanLatency, percentile80_ScanLatency, percentile95_ScanLatency, throughput := RunScanTest(t, configfile)
	Throughput_Range_StaleOk = throughput
	log.Printf("PERFSTAT AverageLatency %v milliseconds", meanLatency)
	log.Printf("PERFSTAT 95thPercentileLatency %v milliseconds", percentile95_ScanLatency)
	log.Printf("PERFSTAT 80thPercentileLatency %v milliseconds", percentile80_ScanLatency)
}

func TestPerfScanThroughput_Range_StaleOk(t *testing.T) {
	log.Printf("In TestPerfScanLatency_Range_StaleOk()")
	log.Printf("PERFSTAT Throughput %v rows/sec", Throughput_Range_StaleOk)
}
...
func TestPerfScanLatency_Lookup_StaleFalse(t *testing.T) {
	...
	_, meanLatency, percentile80_ScanLatency, percentile95_ScanLatency, throughput := RunScanTest(t, configfile)
	Throughput_Lookup_StaleFalse = throughput
	log.Printf("PERFSTAT AverageLatency %v milliseconds", meanLatency)
	log.Printf("PERFSTAT 95thPercentileLatency %v milliseconds", percentile95_ScanLatency)
	log.Printf("PERFSTAT 80thPercentileLatency %v milliseconds", percentile80_ScanLatency)
}

func TestPerfScanThroughput_Lookup_StaleFalse(t *testing.T) {
	log.Printf("In TestPerfScanLatency_Lookup_StaleFalse()")
	log.Printf("PERFSTAT Throughput %v rows/sec", Throughput_Lookup_StaleFalse)
}
...
func TestPerfScanLatency_Range_StaleFalse(t *testing.T) {
	...
	_, meanLatency, percentile80_ScanLatency, percentile95_ScanLatency, throughput := RunScanTest(t, configfile)
	Throughput_Range_StaleFalse = throughput
	log.Printf("PERFSTAT AverageLatency %v milliseconds", meanLatency)
	log.Printf("PERFSTAT 95thPercentileLatency %v milliseconds", percentile95_ScanLatency)
	log.Printf("PERFSTAT 80thPercentileLatency %v milliseconds", percentile80_ScanLatency)
}

func TestPerfScanThroughput_Range_StaleFalse(t *testing.T) {
	log.Printf("In TestPerfScanLatency_Range_StaleFalse()")
	log.Printf("PERFSTAT Throughput %v rows/sec", Throughput_Range_StaleFalse)
}

func RunScanTest(t *testing.T, configfile string) (Result, int64, int64, int64, int64) {
	...
	return GetScanStats(summaryfile, statsfile, t)
...
func GetScanStats(summaryfile, statsfile string, t *testing.T) (Result, int64, int64, int64, int64) {
	result := Result{}
	...
	return result, meanLatency, percentile80_ScanLatency, percentile95_ScanLatency, throughput
}
