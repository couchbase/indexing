...
const (
	...
	REFRESH_TIMESTAMPED_COUNT_STATS
	INDEXER_STATS
	INDEX_STATS_DONE
...
func (m *MsgRecoverIndexResp) GetRecoveryDoneCh() chan bool {
	return m.recoveryDoneCh
}
...
func (m MsgType) String() string {
	...
	case CLUST_MGR_INST_ASYNC_RECOVERY_DONE:
		return "CLUST_MGR_ASYNC_RECOVERY_DONE"
	...
	case REFRESH_TIMESTAMPED_COUNT_STATS:
		return "REFRESH_TIMESTAMPED_COUNT_STATS"
	case INDEXER_STATS:
