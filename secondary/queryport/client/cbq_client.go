...
func (b *cbqClient) GetScanport(
	defnID uint64,
	retry int,
	excludes map[uint64]bool) (queryport []string, targetDefnID uint64, targetIndstID uint64, rollbackTime []int64, partition [][]common.PartitionId, ok bool) {

	return []string{b.queryport}, defnID, 0, []int64{math.MaxInt64}, nil, true
}
