...
const (
	FDB_NONRECOVERABLE_ERR                Error = C.FDB_NONRECOVERABLE_ERR
	FDB_RECOVERABLE_ERR                   Error = C.FDB_RECOVERABLE_ERR
...
var codeMap = map[int]string{
	C.FDB_NONRECOVERABLE_ERR:                `FDB_NONRECOVERABLE_ERR`,
	C.FDB_RECOVERABLE_ERR:                   `FDB_RECOVERABLE_ERR`,
