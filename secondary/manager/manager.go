...
type MetadataNotifier interface {
	...
	OnIndexBuild([]common.IndexInstId, []string, bool, *common.MetadataRequestContext) map[common.IndexInstId]error
...
func (m *IndexManager) HandleBuildIndexRebalDDLEmptyNode(indexIds client.IndexIdList) error {
...
func (m *IndexManager) UpdateIndexInstance(bucket, scope, collection string,
	...
	streamId common.StreamId, updateErr bool, err string, buildTime []uint64, rState common.RebalanceState,
	...
	inst := &topologyChange{
		...
		NumCentroidsPerPartn: numCentroidsPerPartn,
