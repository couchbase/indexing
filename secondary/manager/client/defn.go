...
const (
	...
	OPCODE_BUILD_INDEX_REBAL_EMPTY_NODE                = OPCODE_RESUME_RECOVERED_INDEXES + 1
)
...
func Op2String(op common.OpCode) string {
	...
	case OPCODE_BUILD_INDEX_REBAL_EMPTY_NODE:
		return "OPCODE_BUILD_INDEX_REBAL_EMPTY_NODE"
	}
